...
namespace StarlightRiver.Content.Tiles.Vitric.Temple.LightPuzzle
{
	...
	{
		public static readonly Asset<Texture2D> texture_AssetDirectory_VitricTile___MirrorOver = ModContent.Request<Texture2D>(AssetDirectory.VitricTile + "MirrorOver");
	...
	class LensDummy : ReflectorDummy
	{
		...
		public override void PostDraw(Color lightColor)
		{
			...
			Texture2D texMirror = texture_AssetDirectory_VitricTile___MirrorOver.Value;

...
namespace StarlightRiver.Content.Tiles.Overgrow
{
	...
	{
		public static readonly Asset<Texture2D> texture_AssetDirectory_OvergrowTile___NoxiousNodeGlow = ModContent.Request<Texture2D>(AssetDirectory.OvergrowTile + "NoxiousNodeGlow");
		public static readonly Asset<Texture2D> texture_AssetDirectory_OvergrowTile___NoxiousNode = ModContent.Request<Texture2D>(AssetDirectory.OvergrowTile + "NoxiousNode");
	...
	internal class NoxiousNodeDummy : Dummy, IFaeWhippable
	{
		...
		{
			Texture2D tex = texture_StarlightRiver_Assets_Keys_GlowAlpha.Value;
			...
			Texture2D flowerTex = texture_AssetDirectory_OvergrowTile___NoxiousNode.Value;
			Main.spriteBatch.Draw(flowerTex, pos, null, lightColor, rotation, flowerTex.Size() / 2, 1, 0, 0);

			if (DetachedLife <= 0)
			{
				Texture2D glowTex = texture_AssetDirectory_OvergrowTile___NoxiousNodeGlow.Value;

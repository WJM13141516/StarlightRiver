...
namespace StarlightRiver.Content.Tiles.Misc
{
	class DisplayCase : ModTile, IHintable
	{
		...
		public static readonly Asset<Texture2D> texture_StarlightRiver_Assets_Tiles_Misc_DisplayCaseGlow = ModContent.Request<Texture2D>("StarlightRiver/Assets/Tiles/Misc/DisplayCaseGlow");
		...
		public override bool PreDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			{
				Texture2D outlineTex = texture_StarlightRiver_Assets_Tiles_Misc_DisplayCaseGlow.Value;

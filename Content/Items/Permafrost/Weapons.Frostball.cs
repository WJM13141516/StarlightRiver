...
namespace StarlightRiver.Content.Items.Permafrost
{
	...
	internal class FrostballProjectile : ModProjectile
	{
		...
		public override void PostDraw(Color lightColor)
		{
			...
			effect.Parameters["noiseTexture"].SetValue(texture_StarlightRiver_Assets_Noise_SwirlyNoiseLooping.Value);
			...
			for (int k = 0; k < 3; k++)
			{
				Texture2D texStar = texture_StarlightRiver_Assets_Keys_StarAlpha.Value;

...
namespace StarlightRiver.Content.NPCs.TownUpgrade
{
	...
	{
		public static readonly Asset<Texture2D> texture_StarlightRiver_Assets_NPCs_TownUpgrade____NPC_TypeName___Upgraded = ModContent.Request<Texture2D>("StarlightRiver/Assets/NPCs/TownUpgrade/" + NPC.TypeName + "Upgraded");
		public override bool PreDraw(NPC NPC, SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
		{
			if (NPC.townNPC && NPCUpgradeSystem.townUpgrades.TryGetValue(NPC.TypeName, out bool upgraded) && upgraded)
			{
				Texture2D tex = texture_StarlightRiver_Assets_NPCs_TownUpgrade____NPC_TypeName___Upgraded.Value;

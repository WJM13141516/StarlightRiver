...
namespace StarlightRiver.Content.Bosses.SquidBoss
{
	...
	{
		public static readonly Asset<Texture2D> texture_AssetDirectory_SquidBoss___WindowDomeMap = ModContent.Request<Texture2D>(AssetDirectory.SquidBoss + "WindowDomeMap");
		public static readonly Asset<Texture2D> texture_AssetDirectory_SquidBoss___WindowInMap = ModContent.Request<Texture2D>(AssetDirectory.SquidBoss + "WindowInMap");
		public static readonly Asset<Texture2D> texture_AssetDirectory_SquidBoss___Godray = ModContent.Request<Texture2D>(AssetDirectory.SquidBoss + "Godray");
		public static readonly Asset<Texture2D> texture_AssetDirectory_SquidBoss___WindowInGlow = ModContent.Request<Texture2D>(AssetDirectory.SquidBoss + "WindowInGlow");
		public static readonly Asset<Texture2D> texture_AssetDirectory_SquidBoss___WindowIn = ModContent.Request<Texture2D>(AssetDirectory.SquidBoss + "WindowIn");
		public static readonly Asset<Texture2D> texture_AssetDirectory_SquidBoss___WindowDome = ModContent.Request<Texture2D>(AssetDirectory.SquidBoss + "WindowDome");
		public static readonly Asset<Texture2D> texture_AssetDirectory_SquidBoss___Window = ModContent.Request<Texture2D>(AssetDirectory.SquidBoss + "Window");
		public static readonly Asset<Texture2D> texture_AssetDirectory_SquidBoss___Background2 = ModContent.Request<Texture2D>(AssetDirectory.SquidBoss + "Background2");
		public static readonly Asset<Texture2D> texture_AssetDirectory_SquidBoss___Background1 = ModContent.Request<Texture2D>(AssetDirectory.SquidBoss + "Background1");
		public static readonly Asset<Texture2D> texture_AssetDirectory_SquidBoss___Background0 = ModContent.Request<Texture2D>(AssetDirectory.SquidBoss + "Background0");
		public static readonly Asset<Texture2D> texture_StarlightRiver_Assets_Bosses_SquidBoss_Laser = ModContent.Request<Texture2D>("StarlightRiver/Assets/Bosses/SquidBoss/Laser");
		public static readonly Asset<Texture2D> texture_AssetDirectory_SquidBoss___WaterDistort = ModContent.Request<Texture2D>(AssetDirectory.SquidBoss + "WaterDistort");
		public static readonly Asset<Texture2D> texture_AssetDirectory_SquidBoss___WaterOver = ModContent.Request<Texture2D>(AssetDirectory.SquidBoss + "WaterOver");
		public static readonly Asset<Texture2D> texture_AssetDirectory_SquidBoss___CathedralWater = ModContent.Request<Texture2D>(AssetDirectory.SquidBoss + "CathedralWater");
		public NPC fakeBoss;
		...
		{
			Texture2D tex = texture_AssetDirectory_SquidBoss___CathedralWater.Value;
		...
		private void DrawShine(Rectangle target)
		{
			...
			applyEffect.Parameters["draw"].SetValue(texture_AssetDirectory_SquidBoss___WaterOver.Value);
			applyEffect.Parameters["distort"].SetValue(texture_AssetDirectory_SquidBoss___WaterDistort.Value);
		...
		private void DrawWaterfalls(SpriteBatch spriteBatch)
		{
			...
			Texture2D tex = texture_StarlightRiver_Assets_Bosses_SquidBoss_Laser.Value;
			Texture2D tex2 = texture_StarlightRiver_Assets_Bosses_SquidBoss_Laser.Value;
		...
		public void DrawBigWindow(SpriteBatch spriteBatch)
		{
			...
			//parallax background
			Texture2D layer0 = texture_AssetDirectory_SquidBoss___Background0.Value;
			Texture2D layer1 = texture_AssetDirectory_SquidBoss___Background1.Value;
			Texture2D layer2 = texture_AssetDirectory_SquidBoss___Background2.Value;
			...
			Texture2D backdrop = texture_AssetDirectory_SquidBoss___Window.Value;
			...
			Texture2D dome = texture_AssetDirectory_SquidBoss___WindowDome.Value;
			spriteBatch.Draw(dome, NPC.Center - dome.Size() / 2 + domeOffset - Main.screenPosition, null, Color.White * 0.325f, 0, Vector2.Zero, 1, 0, 0);

			Texture2D glass = texture_AssetDirectory_SquidBoss___WindowIn.Value;
			Texture2D glass2 = texture_AssetDirectory_SquidBoss___WindowInGlow.Value;
			...
			Texture2D ray = texture_AssetDirectory_SquidBoss___Godray.Value;
		...
		{
			Texture2D reflectionMap = texture_AssetDirectory_SquidBoss___WindowInMap.Value;
			Texture2D domeMap = texture_AssetDirectory_SquidBoss___WindowDomeMap.Value;
